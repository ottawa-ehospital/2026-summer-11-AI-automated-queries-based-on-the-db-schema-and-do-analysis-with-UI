# AI Assistant Module Picker Specification

## Purpose

Defines the Health Assistant entry selection experience for vertically browsing and launching AI assistant modules.
## Requirements
...
- **AND** at least the Health Chat, Report Analyze, and Nutrition Monitor modules are available
...
#### Scenario: User launches Nutrition Monitor
- **WHEN** Nutrition Monitor is selected and the user activates the launch action or taps the focused Nutrition Monitor item
- **THEN** the app opens the new Nutrition Monitor module
- **AND** existing Health Chat and Report Analyze workflows remain available when returning to the module picker
