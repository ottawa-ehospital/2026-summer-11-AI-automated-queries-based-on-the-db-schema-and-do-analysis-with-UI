# Backend Report Interpreter API Specification

## Purpose

Defines the backend report interpreter API namespace, upload analysis behavior, OCR support, follow-up chat, and patient-scoped saved record access.
