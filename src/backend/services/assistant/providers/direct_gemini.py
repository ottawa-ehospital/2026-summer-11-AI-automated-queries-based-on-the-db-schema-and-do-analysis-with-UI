...
class DirectGeminiAssistantProvider(AssistantProvider):
    """Example provider for a direct Gemini-style assistant call.

    The current model client owns concrete provider details. This class exists
    as a clean extension example and returns text-only structured responses.
    """
